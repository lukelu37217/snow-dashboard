...
export const CLIENT_PROPERTIES: ClientProperty[] = [
    ...
    { id: 'prop-008', address: '183 Seekings St', zone: 'Headingley South', lat: 49.863390052197204, lng: -97.41954194167224, type: 'residential' },
    { id: 'prop-013', address: '6945 Roblin Blvd', zone: 'Headingley South', lat: 49.86430786322172, lng: -97.33781879558374, type: 'commercial' },
    { id: 'prop-010', address: '48 Deer Pointe Drive', zone: 'Headingley South', lat: 49.86038561936129, lng: -97.3661665036002, type: 'residential' },
    { id: 'prop-019', address: '5 Livingston Way', zone: 'Headingley South', lat: 49.85575125956081, lng: -97.36509039565324, type: 'residential' },
    { id: 'prop-009', address: '278 Deer Pointe Drive', zone: 'Headingley South', lat: 49.85133972006804, lng: -97.36786770304754, type: 'residential' },
    { id: 'prop-011', address: '308 Deer Point Drive', zone: 'Headingley South', lat: 49.85038398696967, lng: -97.36634840304824, type: 'residential' },
    { id: 'prop-063', address: '2 Augusta Drive', zone: 'Headingley South', lat: 49.86244617649917, lng: -97.37499549564798, type: 'residential' },
    { id: 'prop-014', address: '7830 Roblin Blvd', zone: 'Headingley South', lat: 49.86287100125357, lng: -97.38380761838052, type: 'residential' },
    ...
    { id: 'prop-015', address: '8565 Roblin Blvd', zone: 'Headingley North', lat: 49.87006640782997, lng: -97.41872739564242, type: 'residential' },
    { id: 'prop-002', address: '57 Curry Dr', zone: 'Headingley North', lat: 49.87044886328594, lng: -97.40051615700852, type: 'residential' },
    { id: 'prop-005', address: '1096 Green Oaks Lane', zone: 'Headingley North', lat: 49.87207736106371, lng: -97.35309092632414, type: 'residential' },
    { id: 'prop-017', address: '31 Hermitage Road', zone: 'Headingley North', lat: 49.86842957244926, lng: -97.34930936440125, type: 'residential' },
    { id: 'prop-018', address: '6 Hermitage Road', zone: 'Headingley North', lat: 49.865566661931695, lng: -97.35357251837861, type: 'residential' },
    { id: 'prop-004', address: '95 Charlesglen Drive', zone: 'Headingley North', lat: 49.865820249511145, lng: -97.36930573427944, type: 'residential' },
    { id: 'prop-003', address: '75 Charlesglen Drive', zone: 'Headingley North', lat: 49.86701604111262, lng: -97.36873816496166, type: 'residential' },
    ...
    // --- Buchanan ---
    { id: 'prop-026', address: '330 Risbey Crescent', zone: 'Buchanan', lat: 49.89846161035256, lng: -97.31972681096275, type: 'residential' },
    ...
    { id: 'prop-046', address: '3074 Portage Ave', zone: 'Sturgeon Creek', lat: 49.88054439039715, lng: -97.28281174221861, type: 'commercial' },
    ...
    { id: 'prop-036', address: '70 Ascot Bay', zone: 'Elmhurst', lat: 49.85524849229993, lng: -97.26170207236154, type: 'residential' },
    ...
    { id: 'prop-053', address: '60 Eagle Drive', zone: 'Oak Point Highway', lat: 49.93420509315428, lng: -97.22352135814053, type: 'residential' },
